...
import { SC010_V20_Style } from "../SC010_Init/SC010_V20_Style";
...
export const SC010_V00_Init = (props: object) => {
    ...
    const onClickSwitch_SC011 = () => {
        // newStateを初期化
        updateBaseScreenId(CONST_SC000.SCREENID.SC020)
    }
    ...
    return (
        ...
        <View style={SC000_Style.v00_HeaderArea}>
            <Text style={SC010_V20_Style.youkoso}> ようこそ</Text>
            <Text style={SC010_V20_Style.youkoso2}> ここはUNKOのような国💩</Text>
            <Text style={SC010_V20_Style.youkoso3}> UAASです</Text>
            <Button style={SC010_V20_Style.button} onPress={onClickSwitch_SC011}>💩うんこになる💩</Button>
            <Button style={SC010_V20_Style.button2} onPress={onClickSwitch_SC012}>💩すでにうんこ💩</Button>
