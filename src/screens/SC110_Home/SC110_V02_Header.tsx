...
export const SC110_V02_Header = (props: any) => {
    ...
    // ④カスタムフック呼び出し
    // const [updateLayoutPattern] = useState_SC000_LayoutPattern(CONST_SC000.SCREENINFO.SC110)
    ...
    const onClickSwitch_SC110_SC = () => {
        ...
        // newState.screenControllerInfo.layoutPattern = getLayoutPattern(CONST_SC000.SCREENINFO.SC110)
        // // // レイアウトパターン変更
        // updateLayoutPattern()
        // ステートを更新
